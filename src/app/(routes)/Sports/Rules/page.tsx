    ...
    return (
        <div className={styles.container}>
            <Collapsible title={"1.- REGLAS GENERALES. "}>
                ...
                <p>
                    <span>1.5</span> - <mark>CARIBEAPUESTA</mark> se reserva el derecho de rechazar o suspender sin previo aviso a cualquier cliente que sea sospechoso de realizar trampas, piratería informática, manipulación o daños a nuestras operaciones normales de apuestas. (Incluyendo apuestas por internet). Las apuestas realizadas con la intención de engañar, piratear, atacar, manipular o dañar nuestras operaciones se consideraran nulas y sin previo aviso a discreción de <mark>CARIBEAPUESTA</mark>.
                </p>
                <p>
                    <span>1.6</span> - Todos nuestros clientes deben ser mayores de 18 años.
                </p>
                <p>
                    <span>1.7</span> - Todas las reglas, políticas y dividendos publicados aquí, están sujetos a cambios sin previo aviso. Todos los mínimos y máximos pagos están sujetos a cambios sin previo aviso. El máximo precio a pagar en una apuesta de parley o combinada es Bsf. 7.999.
                </p>
                <p>
                ...
                <p>
                    <span>1.18</span> - La fecha y la hora de inicio del evento son dadas solo como guía. Las apuestas se aceptarán solo hasta el comienzo del partido.
                </p>
            </Collapsible>
